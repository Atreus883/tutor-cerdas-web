...
// Anda bisa memindahkan 'styles' ke file CSS terpisah (misal: App.css) agar lebih rapi,
// tapi tetap di sini juga tidak masalah.
const styles = `
...
// Komponen 'AppLayout' ini akan berisi semua UI (header, footer, dll)
// dan bisa mengakses context karena berada di dalam AuthProvider
function AppLayout() {
    ...
    <div className="app-scope">
      ...
      <div className="app-root">
        ...
        <main className="app-main app-container">
          {/* Suspense untuk lazy-loading halaman diletakkan di sini */}
          <Suspense
            fallback={
          ...
          >
            {/* Outlet adalah tempat React Router merender halaman (Admin, Login, dll) */}
            <Outlet />
          </Suspense>
        </main>
...
// Ini adalah arsitektur yang benar.
